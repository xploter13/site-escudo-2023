...
<body>
            ...
            <section class="prt-row contect-section clearfix">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <form class="query_form wrap-form clearfix position-relative" id="form-associate" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>
                                    ...
                                    <div class="col-md-12">
                                        <button
                                            ...
                                            type="button" id="btn-submit">Enviar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        $("#btn-submit").on('click', function() {
            alert('Informações enviadas com sucesso, em breve um de nossos consultores entrarão em contato.');
